...
>> vim.  It's clean and the key functions are easily available, though a little more complex.
...
>> Atom.  I've used it before, and it's very easy to navigate.  It includes a side-by-side view for editing multiple files at once, and can install modules for editing and executing python code.
